...
FCITX_CONFIGURATION(
    ...
    Option<std::string> accessToken{this, "AccessToken",
                                    _("Volcengine AccessToken"), ""};
    Option<std::string> secretKey{this, "SecretKey", _("Volcengine SecretKey"),
                                  ""};
    Option<std::string> cluster{this, "Cluster", _("Volcengine Cluster ID"),
                                ""};
    Option<int> authType{this, "AuthType",
                         _("Auth Type (1=Token, 2=Signature)"), 1};
